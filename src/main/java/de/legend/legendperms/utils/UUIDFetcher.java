...
/**
 * Source: https://gist.github.com/Jofkos/d0c469528b032d820f42
 */
public class UUIDFetcher {
    ...
    public static UUID getUUIDAt(String name, long timestamp) {
        ...
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(String.format(UUID_URL,
                    name,
                    timestamp / 1000)).openConnection();
    ...
    public static String getName(UUID uuid) {
        ...
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(String.format(NAME_URL,
                    UUIDTypeAdapter.fromUUID(uuid))).openConnection();
            connection.setReadTimeout(5000);
            UUIDFetcher currentNameData = gson.fromJson(new BufferedReader(new InputStreamReader(connection.getInputStream())),
                    UUIDFetcher.class);
